    ...
    class Program
    {
        ...
        */
        ...
        public static int RemoveDuplicates(int[] nums)
        {
            try
            {
                ...
                {
                    // If current element is different from previous, increment unique count and replace value
        ...
        */
        ...
        public static IList<int> MoveZeroes(int[] nums)
        {
            try
            {
                if (nums == null || nums.Length == 0)//To handle num array with null array or array with 0 numbers
                    return new List<int>();

                int nonZeroIndex = 0; // the index where the next non-zero element should be placed
                ...
                // Fill the remaining elements after non zero numbers with zeroes
        ...
        */
        public static IList<IList<int>> ThreeSum(int[] nums)
        {
            try
            {
                ...
                // Handle cases where the result would be empty
                if (nums.Length < 3)
                {
                    return result;
                }

                Array.Sort(nums); // Sorting is key for efficient comparison
        ...
        public static int FindMaxConsecutiveOnes(int[] nums)
        {
            try
            {
                ...
                foreach (int num in nums)
                {
                    ...
                    {
                        currentCount = 0; // Reset count for a break in 1s
                    }
                }
        ...
        */
        public static int MaximumGap(int[] nums)
        {
            try
            {
                ...
                // Calculate the maximum gap using the count array
                int maxGap = 0;
        ...
        */
        public static int LargestPerimeter(int[] nums)
        {
            try
            {
                ...
                Array.Sort(nums); // Sort in descending order

                // Iterate in reverse, checking for valid triangles
